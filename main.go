...
func server(args []string) {
	...
	flags.StringVar(&config.AuthURLTemplate, "authurltemplate", "", "")
	flags.StringVar(&config.AuthURLCaCert, "authurlcacert", "", "")
	flags.BoolVar(&config.AuthURLAssumeUniqueUsernames, "authurlassumeuniqueusernames", false, "")
